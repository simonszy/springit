...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        links.forEach((k,v) -> {
            Person u1 = users.get("user@gmail.com");
            Person u2 = users.get("super@gmail.com");
    ...
    private void addUsersAndRoles() {
        ...
        Person user = new Person("user@gmail.com",secret,true,"Joe","User","joedirt");
        user.addRole(userRole);
        user.setConfirmPassword(secret);
        userRepository.save(user);
        users.put("user@gmail.com",user);

        Person admin = new Person("admin@gmail.com",secret,true,"Joe","Admin","masteradmin");
        ...
        Person master = new Person("super@gmail.com",secret,true,"Super","User","superduper");
